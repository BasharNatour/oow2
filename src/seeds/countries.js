        ...
        Country.deleteMany({}).then(() => {
            ...
            return Governorate.deleteMany({}).then(() => {
                const egyptGovernorates = Governorate.create([
                    ...
                    {name:"Damietta", country : egypt._id},
                    {name:"Gharbia", country : egypt._id},
                    {name:"Matruh", country : egypt._id},
                    {name:"Monufia", country : egypt._id},
                    {name:"South Sinai", country : egypt._id},
                    {name:"Suez", country : egypt._id},
                ]);
